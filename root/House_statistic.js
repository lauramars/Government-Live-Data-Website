var app=new Vue({
  ...
  methods:{
   ...
   this.topAverageVotes = [...this.members].sort(function(a,b) {
    ...
    this.total_average= Math.round(this.average_dem*(this.number_dem/this.members.length) + this.average_rep*(this.number_rep/this.members.length))
...
// createAttendanceHouseGlanceTable(statistic);



// if(document.URL.includes("Attendance")){
//     createHouseTablesAttendance(leastAttended, "table2");
//     createHouseTablesAttendance(mostAttended, "table3");
    
//   };
  
//   if (document.URL.includes("Loyalty")){
//     createHouseTablesLoyalty(leastLoayal, "table4");
//     createHouseTablesLoyalty(mostLoayal, "table5");
//   };
...
//   //   Attendance page - Table 1 House at glance----

// function createAttendanceHouseGlanceTable(statistic){
  
//     var houseGlanceTable=document.getElementById("houseData");
//     houseGlanceTable.innerHTML='';
...
//      var dataNameAvg3=document.createTextNode(0+"%");
...
//      let totalAverage = (statistic.average_dem*(statistic.number_dem/members.length)) + (statistic.average_rep*(statistic.number_rep/members.length));
...
//    houseGlanceTable.appendChild(tableRowHeader);
//    houseGlanceTable.appendChild(tableBody);
...
//   function createHouseTablesAttendance(tenPercentArray, tableId){
...
// function createHouseTablesLoyalty(tenPercentArray, tableId){
